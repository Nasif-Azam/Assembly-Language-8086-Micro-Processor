...
DATA SEGMENT
    ...
    ACC_NUM DB "0123456789$"  ;DB = 8bit data
    ACC_LEN DW $-(OFFSET ACC_NUM)-1  ;DW = 16bit data
...
CODE SEGMENT
    ...
    MOV AH, 09H      ;msg passing
    LEA DX, ACC_PROMPT 
    INT 21H
    
    VERIFY_ACC: 
        MOV AH, 01H  ;single digit input
        INT 21H
                    
        CMP AL, 0DH ;0DH = enter button
        JE BREAKA
    ...
    CHECK_PWD PROC NEAR
        ...
        VERIFY_PWD: MOV AH, 08H ;Character input without echo to output device.
                    ...
                    CMP AL, 0DH ;Break if user presses enter key. ODH = enter button
                    JE BREAKP
